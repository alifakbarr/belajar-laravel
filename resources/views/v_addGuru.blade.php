...
@section('content')
    <form action="/guru/validasi" method="post" enctype="multipart/form-data">
      @csrf
      <div class="content">
        <div class="row">
          <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <input type="text" name="mapel_guru" id="mapel_guru" class="form-control" value="{{ old('mapel_guru') }}">
